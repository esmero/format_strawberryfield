...
namespace Drupal\format_strawberryfield\Element;
...
/**
 * Provides an entity autocomplete form element but saves UUID instead of ID.
 *
 ...
 *
 * @FormElement("sbf_entity_autocomplete_uuid")
 */
class EntityAutocompleteUUID extends Textfield {
