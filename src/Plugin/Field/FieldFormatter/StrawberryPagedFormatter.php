  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    return [
      ...
      'mediasource' => [
        ...
        '#options' => [
          'json_key' => $this->t('Strawberryfield JSON Key'),
          'manifesturl' => $this->t('IIIF Manifest URL'),
      ...
      'json_key_source' => [
        ...
        '#states' => [
          'visible' => [
            'select[name="mediasource"]' => ['value' => 'json_key'],
          ],
        ],
      ],
      'manifesturl_source' => [
        ...
        '#states' => [
          'visible' => [
            'select[name="mediasource"]' => ['value' => 'manifesturl'],
          ],
        ],
      ],
      'metadatadisplayentity_source' => [
        ...
        '#states' => [
          'visible' => [
            'select[name="mediasource"]' => ['value' => 'metadatadisplayentity'],
          ],
        ],
      ],
