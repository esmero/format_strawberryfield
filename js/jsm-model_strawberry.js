(function ($, Drupal, once, drupalSettings, JSM) {

  'use strict';

  Drupal.behaviors.format_strawberryfield_jsm_initiate = {
    attach: function(context, settings) {
      const elementsToAttach = once('attache_3d', '.strawberry-3d-item[data-iiif-model]', context);
...
})(jQuery, Drupal, once, drupalSettings, window.JSM);
